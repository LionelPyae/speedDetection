...
while True:
    ...
    # else:
    #     break
    elif(score < 60):  # NIGHT TIME #modify elif
        flag2 = True
        list_speed = []
    ...
    elif cy2 > starttrack:  # modify elif
        if flag2 is True and cy2 < midtrack:
            starttime = datetime.datetime.now()
            flag2 = False
        elif cy2 > midtrack and cy2 < lasttrack:  # modify elif
            endtime = datetime.datetime.now()
        ...
        elif cy2 > lasttrack:  # modify elif
