...
# cap = cv2.VideoCapture('rtsp://admin:ats12345@192.168.0.250/cam/realmonitor?channel=1&subtype=0')
...
while True:
    ...
    cv2.line(roi_, (l1_x1, new__start_y),
             (l1_x2, new__start_y), (0, 255, 0), 1)
    cv2.line(roi_, (l2_x1, new_mid_y), (l2_x2, new_mid_y), (0, 0, 255), 1)
    cv2.line(roi_, (l1_x1, int((new_end_y))),
             (l1_x2, int((new_end_y))), (0, 0, 0), 1)
