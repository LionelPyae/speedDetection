...
# make line
# ymin, xmin, ymax, xmax, object_name, label, scores, frame, frame_rate_cal = get_points(
#     VideoStream)
_, _, _, _, _, _, _, frame, _, _ = get_points(VideoStream)
print('fram_shape: ', frame.shape)
        ...
        if cy > midtrack and cy < pt3_pxl:
            ...
            if seconds <= 0.2:
                ...
                if flag is False:
                    ...
                    cv2.putText(frame, str(int(speed)), (xmin, ymin),
                ...
                cv2.line(frame, (l1_x1, int((pt3_pxl))),
                         (l1_x2, int((pt3_pxl))), (0, 0, 0), 1)
